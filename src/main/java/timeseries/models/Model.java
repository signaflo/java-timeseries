...
public interface Model {
  ...
  /**
   * The model fitted values, which are in-sample one-step ahead forecasts.
   * @return the model fitted values.
   */
  TimeSeries fittedSeries();

  /**
   * The model residuals, the difference between the observed values and the model fitted values.
